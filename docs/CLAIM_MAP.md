...
| Destination catalogue and Hit@R90 | `evaluation37.json`, `matched_robustness.json` | `catalogue.py`, `metrics.py`, `matched_robustness.py` | `canonical_cross_method_cases.csv.gz`, `main_hit_r90.csv` |
| Two-stage catalogue assignment and DBSCAN-membership sensitivity | `evaluation37.json`, `matched_robustness.json` | `catalogue.py`, `matched_robustness.py` | `catalogue_assignment_audit.json`, `catalogue_assignment_sensitivity_cases.csv.gz`, `catalogue_assignment_bootstrap.csv` |
...
| Observation, quality, D200, assignment, and expanded-cohort sensitivity | `matched_robustness.json`, `expanded46.json` | `matched_robustness.py` | observation-definition, D200, assignment, and expanded-cohort outputs |
